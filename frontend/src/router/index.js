...
export default createRouter({
  ...
  routes: [
    ...
    { path: '/print/invoice/:id', component: page('InvoicePrintPage') },
    { path: '/print/prescription/:id', component: page('PrescriptionPrintPage') },
    { path: '/print/discharge/:id', component: page('DischargePrintPage') }
  ]
})
